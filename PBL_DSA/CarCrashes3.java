...
public class CarCrashes3 {
    ...
    private AVLTree2 Hit_And_Run;
    private AVLTree2 Not_Hit_And_Run;
    private String s;
    ...
    public void creatingTwoBinaryTrees() {
        for (int i = 0; i < months.size(); i++) {
            ...
            if(Hit_And_Run == null && Not_Hit_And_Run == null){
                Hit_And_Run = new AVLTree2(hit,month[i]);
                Not_Hit_And_Run = new AVLTree2(notHit,month[i]);
            }else{
    ...
    public void deadliestFriday(){
        ...
        for(int i =0; i < months.size(); i++){
            ...
            if(deadFriday == null){
                deadFriday = new AVLTree2(count,month[i]);
            }else {
    ...
    public void solutionOfProblem2(){
        ...
        System.out.println();
        AVLTree2 rain_Hit_And_Run = null;
        for (int i = 0; i < months.size(); i++) {
            int hit = 0;
            for (int j = 0; j < months.get(i).size(); j++) {
            ...
            if(rain_Hit_And_Run == null){
                rain_Hit_And_Run = new AVLTree2(hit,month[i]);
            }else{
